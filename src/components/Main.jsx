       ...
       <div className="grid md:grid-cols-3 grid-cols-1 gap-12 mb-24 px-5">
        <div className="px-6 py-8 flex flex-col gap-3 shadow-lg  border border-gray-100 rounded-2xl">
            ...
            <div className="min-h-48 flex items-center justify-center">
                <IoCard className="w-40 h-40" color="#214440" />
            </div>
        </div>
        <div className="px-6 py-8 flex flex-col gap-3 shadow-lg  border border-gray-100 rounded-2xl">
            <h3 className="font-bold text-2xl">Streaks</h3>
            <p className="text-gray">7 gün ardarda CoffeeMe dən məhsul ol və Premiumdan faydalan</p>
        ...
        <div className="px-6 py-8 flex flex-col gap-3 shadow-lg  border border-gray-100 rounded-2xl">
            ...
            <p className="text-gray">CoffeeMe Free və Premium planlarından faydalan bilərsiniz</p>
            <div className="min-h-48 flex items-center justify-center">
                <IoCard className="w-40 h-40" color="#214440" />
            </div>
        </div>
